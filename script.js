...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (proySlider) {
    const fotos = [
      ...
      'assets/proyectos/carrusel-9.webp'
    ];
  ...
  if (searchBtns.length) {
    const INDICE = EN ? [
      ...
      { t: 'ESG Pillars — Environment', d: 'Traceable and efficient water use, waste management, sustainable production certified by GLOBALG.A.P.', u: 'index-en#que-hacemos' },
      { t: 'ESG Pillars — Social', d: 'Integrity and ethics, workplace equity, fair compensation, ongoing training, safe infrastructure', u: 'index-en#que-hacemos' },
      { t: 'ESG Pillars — Governance', d: 'Independent board of directors, financial transparency, risk management', u: 'index-en#que-hacemos' },
      { t: 'Experience', d: '+60k hectares: crops, fruit orchards, water management, agricultural innovation, environmental stewardship; KPIs; +25 years', u: 'index-en#proyectos' },
      ...
      { t: 'Pilares ESG — Medio Ambiente', d: 'Uso trazable y eficiente del agua, gestión de residuos, producción limpia GLOBALG.A.P.', u: '/#que-hacemos' },
      { t: 'Pilares ESG — Social', d: 'Integridad y ética, equidad laboral, remuneraciones justas, capacitaciones continuas', u: '/#que-hacemos' },
      { t: 'Pilares ESG — Gobernanza', d: 'Directorio independiente, transparencia financiera, gestión de riesgos', u: '/#que-hacemos' },
      { t: 'Experiencia', d: '+60k hectáreas: cultivos, frutales, gestión hídrica, innovación, impacto ambiental; KPIs; +25 años', u: '/#proyectos' },
  ...
  // ----- Contacto: arma el correo y abre el gestor del visitante -----
  //
  // El sitio es estatico y no puede enviar correo por si solo. Al pulsar Enviar
  // se arma un enlace mailto con los datos del formulario y se abre el programa
  // de correo del visitante, que es quien finalmente lo envia.
  const CONTACTO_DESTINO = 'plopez@ttagro.cl';
  ...
  if (contactoForm) {
    ...
    contactoForm.addEventListener('submit', e => {
      ...
      const d = new FormData(contactoForm);
      const sel = contactoForm.querySelector('#cf-area');
      // del desplegable interesa la etiqueta visible, no el valor interno
